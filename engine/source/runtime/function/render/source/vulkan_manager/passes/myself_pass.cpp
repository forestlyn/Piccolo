...
namespace Pilot
{
    void PMySelfPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PMySelfPass::setupDescriptorSetLayout()
    {
    ...
    void PMySelfPass::setupPipelines()
    {
        ...
        pipelineInfo.subpass = _main_camera_subpass_myself_pass;
    ...
    void PMySelfPass::setupDescriptorSet()
    {
    ...
    void PMySelfPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "MySelf Pass", {1.0f, 1.0f, 1.0f, 1.0f} };
